...
class DPCRN_model():
    ...
    def build_DPCRN_model(self, name = 'model0'):
        ...
        if batchNorm_enable:
            ...
            out_1 = PReLU(shared_axes=[1,2])(conv_1)
        ...
        if batchNorm_enable:
            ...
            out_2 = PReLU(shared_axes=[1,2])(conv_2)
        ...
        if batchNorm_enable:
            ...
            out_3 = PReLU(shared_axes=[1,2])(conv_3)
        # causal padding [1,0],[1,1]
        ...
        if batchNorm_enable:
            ...
            out_4 = PReLU(shared_axes=[1,2])(conv_4)
        # causal padding [1,0],[1,1]
        ...
        if batchNorm_enable:
            ...
            out_5 = PReLU(shared_axes=[1,2])(conv_5)
        ...
        if batchNorm_enable:
            ...
            dout_1 = PReLU(shared_axes=[1,2])(deconv_1)
        ...
        if batchNorm_enable:
            ...
            dout_2 = PReLU(shared_axes=[1,2])(deconv_2)
        ...
        if batchNorm_enable:
            ...
            dout_3 = PReLU(shared_axes=[1,2])(deconv_3)
        ...
        if batchNorm_enable:
            ...
            dout_4 = PReLU(shared_axes=[1,2])(deconv_4)
        ...
        if fftifft_enable:
            ...
            self.model = Model(time_dat,output_mask)
        self.model.summary()
